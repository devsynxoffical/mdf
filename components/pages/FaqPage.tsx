        ...
        <div className="relative mx-auto max-w-[1040px] px-4 sm:px-6 md:px-10">
          ...
          <div className="inline-flex items-center gap-2.5 rounded-full border border-sky/30 bg-sky/10 px-4 py-1.5 backdrop-blur-md">
            ...
            <span className="font-mono text-[11px] font-bold uppercase tracking-[0.2em] text-sky">
              Direct Answers · System Clearance
            </span>
          </div>

          <div className="mt-8 grid gap-10 lg:grid-cols-[1.3fr_0.7fr] lg:items-end">
            <div>
              <h1 className="font-sans text-[clamp(40px,5.8vw,68px)] font-extrabold leading-[1.04] tracking-[-0.035em] text-white">
                <Reveal as="span">
              ...
              <p className="mt-6 max-w-[50ch] font-sans text-[16.5px] leading-[1.75] text-slate-300 sm:text-[18px]">
            ...
            <div className="grid grid-cols-2 gap-3 rounded-2xl border border-white/15 bg-gradient-to-b from-white/[0.08] via-white/[0.03] to-white/[0.01] p-4 sm:p-6 shadow-[0_20px_50px_rgba(0,0,0,0.6)] backdrop-blur-xl">
              <div className="text-center sm:text-left">
                <p className="font-sans text-[clamp(30px,3.8vw,40px)] font-black leading-none text-sky">
                  10 Core
                </p>
                <p className="mt-2 font-mono text-[10px] font-bold uppercase tracking-[0.14em] text-slate-400">
                  Topics Covered
                </p>
              </div>
              <div className="border-l border-white/10 pl-3 text-center sm:text-left">
                <p className="font-sans text-[clamp(30px,3.8vw,40px)] font-black leading-none text-amber-300">
                  3–4 Wks
                </p>
